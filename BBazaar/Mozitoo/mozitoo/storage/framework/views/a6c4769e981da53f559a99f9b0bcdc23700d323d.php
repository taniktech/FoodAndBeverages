...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(URL::to('src/vendors/flexslider/flexslider.css')); ?>" media="screen" />
    <!--Responsive Style-->
...
<body class="default light">
  ...
  <?php echo $__env->make('includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <?php echo $__env->yieldContent('property_grid'); ?>
    <?php echo $__env->yieldContent('agents'); ?>
    <?php echo $__env->yieldContent('blogs'); ?>
    <?php echo $__env->yieldContent('oneblog'); ?>
    <?php echo $__env->yieldContent('forgotpwd'); ?>
    <?php echo $__env->yieldContent('contactus'); ?>
    <?php echo $__env->yieldContent('shopearn'); ?>
    <?php echo $__env->yieldContent('property_details'); ?>
    <?php echo $__env->yieldContent('terms_of_use'); ?>
