<?php $__env->startSection('welcomepage'); ?>
<!--Content Area Begin-->
        ...
        <div class="row text-center">
            <div class="col-sm-3 col-lg-offset-1 service_block mar">
                <div class="row m0 inner">
                    ...
                    <a href="<?php echo e(route('marketingrenting')); ?>" class="read_more">+ read more</a>
                </div>
            </div>
            <div class="col-sm-3 service_block">
                <div class="row m0 inner">
                    ...
                    <a href="<?php echo e(route('freerentpriceanlys')); ?>" class="read_more">+ read more</a>
                </div>
            </div>
            <div class="col-sm-3 service_block">
                <div class="row m0 inner">
                    ...
                    <a href="<?php echo e(route('rentmanagement')); ?>" class="read_more">+ read more</a>
                </div>
            </div>
        </div>
    </div>
