<?php $__env->startSection('adminsubmitform'); ?>
...
<?php echo $__env->make('includes.adminfooter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    var adminsubmitnewform = '<?php echo e(route('admin.submitnewform')); ?>';
    var adminsubmitnewformone = '<?php echo e(route('admin.submitnewformone')); ?>';
    </script>
    <script>
