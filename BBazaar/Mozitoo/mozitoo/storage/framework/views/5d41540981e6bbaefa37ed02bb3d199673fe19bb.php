    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                  <a href="<?php echo e(route('switch.toten.dashboard')); ?>">Switch To Tenant Dashboard</a>
               </li>
              <li>
                <li>
                   <a href="javascript:void(0)">
                       <p>Hello <?php echo e($owner->name); ?></p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('owner.logout')); ?>">
                        <p>Log out</p>
                    </a>
                </li>
...
<?php /* <div class="modal fade" id="switch-to-tenant" role="dialog" data-backdrop="false" style="background-color: rgba(0, 0, 0, 0.5);">
