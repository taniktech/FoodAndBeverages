                    ...
                    <div class="content">
                        ...
                        <div class="footer">
                            ...
                            <div class="stats">
                                ...
                                <a href="<?php echo e(route('admin.inventory.review.all')); ?>"><i class="pe-7s-angle-right-circle"></i> Refresh </a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h4 class="title">All Inventory List</h4>
                    <p class="category">All Inventory List</p>
                </div>        
                <div class="content table-responsive table-full-width">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            $i = 0;
                             ?>
                            <?php foreach($all_invnt as $one_invnt): ?>
                            <?php 
                            $i++;
                             ?>
                            <tr>
