...
<body>
<div class="wrapper">
		<?php echo $__env->yieldContent('tenant'); ?>
		<?php echo $__env->yieldContent('tenantproperties'); ?>
		<?php echo $__env->yieldContent('pendingone'); ?>
		<?php echo $__env->yieldContent('tenantserreqform'); ?>
		<?php echo $__env->yieldContent('tenantpwd'); ?>
    <?php echo $__env->yieldContent('tenantservicerequests'); ?>
    <?php echo $__env->yieldContent('tenant_profile'); ?>
    <?php echo $__env->yieldContent('ten_submit_prop'); ?>
    <?php echo $__env->yieldContent('tenant_all_invoices'); ?>
    <?php echo $__env->yieldContent('tenant_one_invnt_details'); ?>
    <?php echo $__env->yieldContent('payment_options'); ?>
</div>
  <!--   Core JS Files   -->
...
<script src="<?php echo e(URL::to('src/adminassets/js/tenantsteps.js')); ?>"></script>
