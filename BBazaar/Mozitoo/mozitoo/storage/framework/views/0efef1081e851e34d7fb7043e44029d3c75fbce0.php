                ...
                <div class="content table-responsive table-full-width">
                    ...
                    <table class="table table-hover table-striped" id="oat-invnt-ten-table">
                        ...
                        <tbody>
                            ...
                            $i = 0;
                             ?>
                            <?php foreach($tenants as $one_tenant): ?>
                                <?php 
                                $i++;
                                $ten = 0;
                                $id = 0;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    $tmp_id_0 = Crypt::encrypt($id);
                                     ?>
                                    <a href="<?php echo e(route('owner.rental.agreement.get',['tmp_id_0'=>$ten,'tmp_id_1'=>$tmp_id_0, 'Agreement'=>'Agreement'])); ?>" target="_blank">View PDF</button>
                                    <?php else: ?>
                                    <button type="button" class="u-r-a-p btn btn-info" data-id="<?php echo e($ten); ?>" data-idd="<?php echo e($id); ?>">Upload</button>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
...
var url_renatl_upload = '<?php echo e(route('rental.agreement.upload')); ?>';
</script>
<?php $__env->stopSection(); ?>
