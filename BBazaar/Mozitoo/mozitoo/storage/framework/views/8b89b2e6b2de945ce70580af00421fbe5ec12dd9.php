<?php $__env->startSection('submitnew'); ?>
<!--Content Area Begin-->
...
var submitnewform = '<?php echo e(route('submitnewform')); ?>';
...
<?php echo $__env->make('layouts.submitmaster', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>