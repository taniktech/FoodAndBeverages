<?php $__env->startSection('shopearn'); ?>
<!--Content Area Begin-->
    ...
    <section id="slider" class="row" style="margin-top:70px;">
        <div class="flexslider mainSlider" id="mainSlider">
            <ul class="slides">
                <li>
                    <img src="<?php echo e(URL::to('src/images/slides/x1.jpg')); ?>" alt="">
                ...
                <li>
                    <img src="<?php echo e(URL::to('src/images/slides/x2.jpg')); ?>" alt="">
                    <div class="row m0 captions">
                        <div class="container">
                            <div class="row m0">
              ...
              <div class="col-sm-6 col-md-4 col-lg-3 agent">
                <div class="row m0">
                    <div class="row m0 imageRow">
                        ...
                        <img src="<?php echo e(URL::to('src/images/slides/x3.jpg')); ?>" alt="" class="img-responsive"></a>
                    </div>
                </div>
            </div> <!--Agent Block-->
            </div>
