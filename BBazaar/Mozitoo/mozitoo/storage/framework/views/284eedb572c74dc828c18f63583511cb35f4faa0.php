                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <form id="user-name-update">
                                                        <input type="text" class="form-control" disabled="disabled" placeholder="Your Name" name="user_name" id="user-name" value="<?php echo $owner->name; ?>">
                                                    </form>
                                                </div>
...
var url_switch_owner_dash = '<?php echo e(route('switch.toten.dashboard')); ?>';
...
var url_owner_post_address = '<?php echo e(route('owner.save.address')); ?>';
var url_owner_post_bank_details = '<?php echo e(route('owner.save.bank.details')); ?>';
var url_owner_post_about_me = '<?php echo e(route('owner.save.about.me')); ?>';
</script>
