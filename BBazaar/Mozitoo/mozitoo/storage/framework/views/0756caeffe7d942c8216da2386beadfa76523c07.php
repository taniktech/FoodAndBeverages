        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <?php if($owner_profile): ?>
                <li>
                    <?php /* <a data-toggle="modal" href="javascript:void(0)" data-target="#switch-to-owner">Switch To Owner Dashboard</a> */ ?>
                    <a href="<?php echo e(route('switch.toowner.dashboard')); ?>">Switch To Owner Dashboard</a>
                 </li>
                 <?php endif; ?>
                <li>
...
<?php /* <div class="modal fade" id="switch-to-owner" role="dialog" data-backdrop="false" style="background-color: rgba(0, 0, 0, 0.5);">
