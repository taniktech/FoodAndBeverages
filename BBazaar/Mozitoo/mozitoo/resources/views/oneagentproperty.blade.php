...
<div class="main-panel">
  ...
  Property Manager Dashboard / All Properties / Review One
  @endsection
        ...
        <div class="col-md-4" id="mobile-property-image">
          <div class="card card-user">
            ...
            <div class="property-image" style="margin-top:10px; margin-bottom:10px;">
              <p class="description text-center"> Property image Uploaded by You
              </p>
            </div>
            @else
                  ...
                  <form id="oneAgentPropertyForm">
                      <input type="text" hidden name="propertyID" id="propertyID" value="{!! $oneProperty->prop_id !!}">
                        ...
                        <div class="row">
                          ...
                          <a href="{{route('oneagentproperty.delete',['prop_id'=>$oneProperty->prop_id])}}"><button type="button" class="btn btn-danger btn-fill">Delete</button></a>
...
var UrlUpdateOneAgentProperty = '{{route('update.one.agent.property')}}';
var agentAllProp = '{{route('agent.property.all')}}';
</script>
<script>
