                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <form id="user-name-update">
                                                                <input type="text" class="form-control" disabled="disabled" placeholder="Your Name" name="user_name" id="user-name" value="{!! $tenant->name !!}">
                                                            </form>
                                                        </div>
...
var url_tenant_post_address = '{{route('tenant.save.address')}}';
var url_tenant_post_bank = '{{route('tenant.save.bank.details')}}';
var url_tenant_post_about = '{{route('tenant.save.about.me')}}';
</script>
