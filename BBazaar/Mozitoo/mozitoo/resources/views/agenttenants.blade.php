...
<div class="main-panel">
  @section('DashboardSiteMap')
      Property Manager Dashboard / All Tenant Info
  @endsection
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                              ...
                              @endphp
                                <tr>
                                  <td>{{$i}}</td>
                                  <td>{{ $oneTenantTaggedId->tsSubmittedPropFun->prop_title }}<a href="{{route('oneagentproperty.check',['prop_id'=>$oneTenantTaggedId->prop_id])}}"><span style="color: green;font-size: 10px;"> Click to see details</span></a></td>
