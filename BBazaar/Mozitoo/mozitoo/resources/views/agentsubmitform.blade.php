...
<div class="main-panel">
  @section('DashboardSiteMap')
      Property Manager Dashboard / Add new property
  @endsection
@include('includes.agentnav')
              ...
              <div class="col-md-12">
                  <div class="card">
                      <div class="header" style="padding-bottom:20px;">
                          ...
                          <p class="category">You can add property on behalf of owner.</p>
                      </div>
                    </div>
              </div>
          </div>
                      ...
                      <fieldset class="field5">
                          <div class="form-group user_type type_switch">
                              ...
                              <label for="user_type" class="switch">
                                  <span class="new_user switch_left">New Owner</span>
                                  <span class="indicator"><span class="switch_dot"></span></span>
                                  <span class="existing_user switch_right">Existing Owner</span>
                              </label>
                          </div>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div style="" class="modal-header">
                  <h3 style="text-align:center" class="modal-title"> Successfully Posted</h3>
              </div>
    ...
    var agentsubmitnewform = '{{route('agent.submitnewform')}}';
    var agentsubmitnewformone = '{{route('agent.submitnewformone')}}';
