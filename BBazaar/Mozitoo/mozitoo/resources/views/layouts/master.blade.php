...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::to('src/vendors/range-slider/css/bootstrap-slider.min.css') }}"/>
    ...
    <link rel="stylesheet" href="{{ URL::to('src/css/responsive5steps.css') }}">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

    <link rel="stylesheet" href="{{ URL::to('src/css/rentmgmtcard.css') }}">
    <link rel="stylesheet" href="{{ URL::to('src/css/rentmgmtcard.css') }}">
    <link rel="stylesheet" href="{{ URL::to('src/css/rentmgmt.css') }}">
    <link rel="stylesheet" href="{{ URL::to('src/css/range-search.css') }}">
</head>
...
<script src="{{ URL::to('src/vendors/range-slider/js/bootstrap-slider.min.js') }}"></script>
...
<script src="{{ URL::to('src/js/sliderCustom.js') }}"></script>
