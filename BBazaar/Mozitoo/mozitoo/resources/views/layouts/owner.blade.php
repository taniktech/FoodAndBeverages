...
<div class="wrapper">
		@yield('owner')
		@yield('ownerproperties')
		@yield('pendingone')
		@yield('ownersubmitform')
		@yield('ownerprofile')
		@yield('ownerserreqform')
		@yield('ownerpwd')
		@yield('ownerservicerequests')
		@yield('ownerpendingprops')
		@yield('approvalpendingone')
		@yield('owner_profile')
		@yield('owner_one_invnt_details')
		@yield('owner_all_invoices')
</div>
  <!--   Core JS Files   -->
...
<script src="{{ URL::to('src/adminassets/js/ownersteps.js') }}"></script>
