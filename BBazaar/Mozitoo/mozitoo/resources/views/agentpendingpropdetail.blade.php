...
<div class="main-panel">
  ...
  Property Manager Dashboard /Pending Properties / Review One
  @endsection
        ...
        <div class="col-md-4" id="mobile-property-image">
          ...
          <div class="col-md-8">
              <div class="card">
                  ...
                  <hr/>
                  <div class="content">
                  <form id="oneAgentPendingPropertyApproval">
...
var UrlUpdateOneAgentPendingPropApproval = '{{route('update.one.agent.pending.property')}}';
