        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="content table-responsive table-full-width">
                    @if(isset($one_tenant) && $one_tenant)
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <a href="{{route('tenant.rental.agreement.get',['tmp_id_1'=>$tmp_id_0, 'Agreement'=>'Agreement'])}}" target="_blank">View PDF</button>
                                    @else
                                    <button type="button" class="u-r-a-ten-p btn btn-info" data-idd="{{$id}}">Upload</button>
                                    @endif
                                </td>
                            </tr>
                        </tbody>
...
var url_renatl_upload = '{{route('rental.tenant.agreement.upload')}}';
</script>
@endsection
