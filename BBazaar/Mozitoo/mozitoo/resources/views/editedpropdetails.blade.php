...
<div class="main-panel">
  ...
  Admin Dashboard /Edited Property Requests / Review
  @endsection
  ...
  <div class="container-fluid">
      <div class="row">
        <div class="col-md-4" id="mobile-property-image">
          ...
          @if (Storage::disk('public_uploads')->has($oneProperty->prop_id.'_tmp.jpg'))
          <div class="card card-user">
            <img src="{{ route('prop.image', ['filename' => $oneProperty->prop_id.'_tmp.jpg']) }}" alt="" class="img-responsive">
            <div class="property-image" style="margin-top:10px; margin-bottom:10px;">
              <p class="description text-center">Another Property image Uploaded by User
              </p>
            </div>
          </div>
          @endif
          ...
          <div class="col-md-8">
              <div class="card">
                  ...
                  <hr/>
                  <div class="content">
                  <form id="pendingEditedPropertyForm">
                      <input type="text" hidden name="propertyID" id="propertyID" value="{!! $oneProperty->prop_id !!}">
                        ...
                        <div class="row">
                          ...
                          <a href="{{route('oneproperty.edited.delete',['prop_id'=>$oneProperty->prop_id])}}"><button type="button" class="btn btn-danger btn-fill">Delete</button></a>
...
var UrlUpdateEditedProperty = '{{route('update.edited.property')}}';
