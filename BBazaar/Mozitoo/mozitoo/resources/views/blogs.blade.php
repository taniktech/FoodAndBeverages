            ...
            <div class="col-sm-4 blog">
                <div class="row m0 inner">
                    <div class="row m0 imageRow">
                        <img src="{{ URL::to('src/images/blog/1.jpg') }}" alt="">
                    ...
                    <div class="row m0 desc">
                        ...
                        <p>A rent agreement is an important document that legally lays down the terms and conditions agreed upon by the tenant and the landlord..<a href="{{route('blog.one')}}" class="read_more">[ read more ]</a></p>
                    </div>
                </div>
            </div> <!--blog-->
        </div>
