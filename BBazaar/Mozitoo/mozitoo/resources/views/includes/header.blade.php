                  ...
                  <div class="col-sm-6 top_menu">
                      <ul class="list-inline">
                          <li>
                            <div class="input-group-btn filterGroup">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                    <a href="#"><i class="fa fa-user"></i> HI @if($owner){{ $owner->name }} @endif</a>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    <li><a href="{{route('ownerdashboard')}}">Account</a></li>
                                    <li><a href="{{route('owner.logout')}}">Log Out</a></li>
                                </ul>
                            </div>
                          </li>
                      </ul>
                  ...
                  <div class="col-sm-6 top_menu">
                      <ul class="list-inline">
                          <li>
                            <div class="input-group-btn filterGroup">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                    <a href="#"><i class="fa fa-user"></i> HI @if($agent){{ $agent->name }} @endif</a>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    <li><a href="{{route('agent')}}">Account</a></li>
                                    <li><a href="{{route('agent.logout')}}">Log Out</a></li>
                                </ul>
                            </div>
                          </li>
                      </ul>
                  </div>
                  @elseif (Auth::check() && Auth::user()->user_type_id == '1')
                  <div class="col-sm-6 top_menu">
                      <ul class="list-inline">
                          <li>
                            <div class="input-group-btn filterGroup">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                    <a href="#"><i class="fa fa-user"></i> HI @if($admin){{ $admin->name }} @endif</a>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="mainNavigation">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{route('shop.and.earn')}}">Shop & Earn</a></li>
