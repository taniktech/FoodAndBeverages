                ...
                <div class="table-responsive table-full-width">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <td class="text-left">@if($prop_mgr->userFun){{ $prop_mgr->userFun->name }}@else N/A @endif</td> 
                            </tr>  
                            <tr>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h4 class="title">Inventory - {{$i}}  @if($one_tenant->invnt_status_id == 2 && $one_tenant->user_id != 0)<i class="pe-7s-check icon-success"></i>@else<i class="pe-7s-attention icon-danger"></i>@endif</h4>
                    @php
                    ...
                    @endphp    
                    <a href="{{route('oneownerproperty.check.oneinvnt',['prop_id'=>$prop_id,'invnt_id'=>$parameter,'check'=>$f_invnt_id])}}">See more</a>
                    <div class="content">
...
var UrlUpdateOneOwnerProperty = '{{route('update.one.owner.property')}}';
var ownerAllProp = '{{route('owner.property.all')}}';
</script>
<script>
